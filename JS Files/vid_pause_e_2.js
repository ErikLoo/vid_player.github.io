...
// var vid_1_pause_array = remove_redundant_pause([2.43, 9.37, 12.77, 14.03, 16.59, 20.47, 21.59, 28.06, 46.89, 54.18, 62.67, 64.37, 71.86, 78.81, 84.18, 87.44, 91.53, 98.59, 107.34, 118.47, 126.06, 138.72]);
var vid_1_pause_array = [9.37, 21.59, 28.06, 46.89, 54.18, 71.86, 78.81, 84.18, 91.53, 107.34, 118.47, 126.06];
var vid_1_duration_array = [300, 300, 300, 300, 300, 300, 300, 300, 300, 300, 300, 300, 300,300,300,300,300,300,300,300,300,300,300,300,300];
vid_1_speed = 154.85;
...
var vid_2_pause_array = [23.22, 31.49, 39.53, 52.79, 78.6, 86.73, 97.74, 106.62, 132.19, 141.02]
...
var vid_3_pause_array = [6.1, 14.88, 22.7, 42.4, 50.09, 71.86, 83.27, 92.93, 105.86, 118.25, 127.74];
var vid_3_duration_array = [300, 300, 300, 300, 300, 300, 300, 300, 300, 300, 300, 300, 300,300,300,300,300,300,300,300];
vid_3_speed = 165.62;


var vid_4_pause_array = [25.93, 36.68, 49.31, 59.06, 67.69, 84.35, 101.24, 111.24, 124.6, 137.9];

var vid_4_duration_array = [300, 300, 300, 300, 300, 300, 300, 300, 300, 300, 300, 300, 300,300,300,300,300,300,300,300];
vid_4_speed = 165.62;
...
var pausing_function = function(){
    ...
    if(Math.abs(v_current_t-old_f_num)>0.3 && isIn(v_current_t, pause_array) == true && duration_array[count]>=1)
    {
        if (video.paused!=true && pause_on==true){
            video.pause();
            pause_count_a++; 
            pause_loc_a.push(video.currentTime); 
            // blur the video
            // blur_video();
            darken_video(); 
            during_pause = true; 
...
function remove_redundant_pause(old_array){
    ...
    if (current_video=='vid_1'){
        avg_vid_dur = 4.76;
    }else if(current_video=='vid_1'){
        avg_vid_dur = 4.087;
    }else if(current_video=='vid_1'){
        avg_vid_dur = 5.226;
    }
    ...
    for (i=0;i<old_array.length;i++){
        //this is adaptive to the video speed
        //vid 1 = 4.76
        //vid 2 = 4.087
        //vid 3 = 5.226
        //vid 4 = 7.14

        if(old_array[i]-new_array[new_array.length-1]>=avg_vid_dur){
